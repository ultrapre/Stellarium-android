...
StelDialog {
	...
	Column {
		...
		Text {
            ...
            text: "<h2>Stellarium Mobile v" + stellarium.version + "<br></h2>Copyrights (C) 2014<br>Fabien &amp; Guillaume Chéreau<br>Modded by Xinlun Cheng<br>Revision by ultrapre<br>GNU GPL"
			width: parent.width
