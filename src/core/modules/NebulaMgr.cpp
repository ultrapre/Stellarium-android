...
void NebulaMgr::init()
{
    ...
    /*
    Nebula::texCircle			= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb.png");		// Load circle texture
    Nebula::texGalaxy			= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb_gal.png");	// Load ellipse texture
    Nebula::texOpenCluster			= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb_ocl.png");	// Load open cluster marker texture
    Nebula::texGlobularCluster		= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb_gcl.png");	// Load globular cluster marker texture
    Nebula::texPlanetaryNebula		= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb_pnb.png");	// Load planetary nebula marker texture
    Nebula::texDiffuseNebula		= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb_dif.png");	// Load diffuse nebula marker texture
    Nebula::texOpenClusterWithNebulosity	= StelApp::getInstance().getTextureManager().createTextureThread(StelFileMgr::getInstallationDir()+"/textures/neb_ocln.png");	// Load Ocl/Nebula marker texture
    */
	// Load circle texture
...
struct DrawNebulaFuncObject
{
	...
	void operator()(StelRegionObject* obj)
	{
		...
		//silas:whem size == 0: can'nt show :bugfix
...
void NebulaMgr::loadNebulaSet(const QString& setName)
{
    ...
    /*
    qDebug()<<"checked_show" << conf->value("nebula/checked_show",2).toInt();
    qDebug()<<"    limit_mag_show" << conf->value("nebula/limit_mag_show", 99).toFloat();
    qDebug()<<"    limit_size_show" << conf->value("nebula/limit_size_show", 0).toFloat();

    qDebug()<<"    Messier_show" << conf->value("nebula/Messier_show", true).toBool();
    qDebug()<<"    Caldwell_show" << conf->value("nebula/Caldwell_show", true).toBool();
    qDebug()<<"    NGC_show" << conf->value("nebula/NGC_show", true).toBool();
    qDebug()<<"    IC_show" << conf->value("nebula/IC_show", true).toBool();
    qDebug()<<"    Other_show" << conf->value("nebula/Other_show", true).toBool();

    qDebug()<<"    Gxy_show" << conf->value("nebula/Gxy_show", true).toBool();
    qDebug()<<"    OCL_show" << conf->value("nebula/OCL_show", true).toBool();
    qDebug()<<"    GCL_show" << conf->value("nebula/GCL_show", true).toBool();
    qDebug()<<"    Nb_show" << conf->value("nebula/Nb_show", true).toBool();
    qDebug()<<"    PN_show" << conf->value("nebula/PN_show", true).toBool();
    qDebug()<<"    NotFound_show" << conf->value("nebula/NotFound_show", false).toBool();
    qDebug()<<"    SNR_show" << conf->value("nebula/SNR_show", true).toBool();
    qDebug()<<"    GxyP_show" << conf->value("nebula/GxyP_show", true).toBool();
    qDebug()<<"    Ass_show" << conf->value("nebula/Ass_show", true).toBool();
    qDebug()<<"    StarCloud_show" << conf->value("nebula/StarCloud_show", true).toBool();
    qDebug()<<"    Stars_show" << conf->value("nebula/Stars_show", true).toBool();
    qDebug()<<"    CarbonStar_show" << conf->value("nebula/CarbonStar_show", true).toBool();
    qDebug()<<"    Dup_show" << conf->value("nebula/Dup_show", false).toBool();
    qDebug()<<"    DarkNebula_show" << conf->value("nebula/DarkNebula_show", true).toBool();
    qDebug()<<"    Cluster_nebula_show" << conf->value("nebula/Cluster_nebula_show", true).toBool();
    qDebug()<<"    Gxy_Cluster_show" << conf->value("nebula/Gxy_Cluster_show", true).toBool();
    qDebug()<<"    IFN_show" << conf->value("nebula/IFN_show", true).toBool();
    qDebug()<<"    DoubleStar_show" << conf->value("nebula/DoubleStar_show", true).toBool();
    qDebug()<<"    VariableStar_show" << conf->value("nebula/VariableStar_show", true).toBool();
    */
	...
	qDebug()<<"nebula_data_file "<<nebula_data_file;
	qDebug()<<"nebula_name_file "<<nebula_name_file;

	QString ngcPath = StelFileMgr::findFile("nebulae/" + setName + "/"+nebula_data_file);
	QString ngcNamesPath = StelFileMgr::findFile("nebulae/" + setName + "/"+nebula_name_file);

	qDebug()<<"loadNGC "<<ngcPath;
	qDebug()<<"loadNGCnames "<<ngcNamesPath;
...
bool NebulaMgr::loadNGC(const QString& catNGC)
{
	...
	if (1){ //judgetoInput(e) && judgeObserved(e)){
            nebArray.append(e);
            nebGrid.insert(qSharedPointerCast<StelRegionObject>(e));
            if (e->NGC_nb!=0)
                ngcIndex.insert(e->NGC_nb, e);
